  ...
  <div class="box">
    ...
    <div class="box-body">
      <table class="table table-hover" id="all-product-table">
        <thead>
          <tr>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', \App\Models\Product::class)): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hype-dappr\resources\views/admin/product/index.blade.php ENDPATH**/ ?>