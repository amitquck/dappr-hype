    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <fieldset>
          ...
          <?php if(isset($product) && $product->featureImage): ?>
            <img src="<?php echo e(get_storage_file_url($product->featureImage->path, 'small'), false); ?>" alt="<?php echo e(trans('app.featured_image'), false); ?>">
            <label>
...
<?php /**PATH C:\xampp\htdocs\hype-dappr\resources\views/admin/product/_form.blade.php ENDPATH**/ ?>