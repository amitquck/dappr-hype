<div class="form-group">
  <?php echo Form::label('category_group_id', trans('app.form.category_group').'*'); ?>

  <?php echo Form::select('category_group_id', $catGroups , null, ['class' => 'form-control select2', 'placeholder' => trans('app.placeholder.category_group'), 'required']); ?>

  <div class="help-block with-errors"></div>
</div>
<div class="form-group">
  <?php echo Form::label('name', trans('app.form.category_sub_grp_name').'*'); ?>

  <?php echo Form::text('name', null, ['class' => 'form-control makeSlug', 'placeholder' => trans('app.placeholder.category_sub_grp_name'), 'required']); ?>
...
<div class="form-group">
  ...
  <?php if(isset($categorySubGroup) && Storage::exists(optional($categorySubGroup->image)->path)): ?>
    <img src="<?php echo e(get_storage_file_url(optional($categorySubGroup->image)->path, 'small'), false); ?>" width="" alt="<?php echo e(trans('app.cover_image'), false); ?>">
...
<p class="help-block">* <?php echo e(trans('app.form.required_fields'), false); ?></p><?php /**PATH C:\wamp64\www\hype-dappr\resources\views/admin/category/_formSubGrp.blade.php ENDPATH**/ ?>