        ...
        <?php if($categoryGroup->subGroups->count()): ?>
          <div class="col-md-3 col-sm-6 bg-light category-widget space30">
            <section class="category-banner-img-wrapper">
              <div class="banner banner-o-hid" style="background-image:url( <?php echo e(get_cover_img_src($categoryGroup, 'category'), false); ?> );">
...
<?php /**PATH C:\wamp64\www\hype-dappr\public\themes\default/views/contents/categories_page.blade.php ENDPATH**/ ?>