...
<div class="form-group">
  ...
  <?php echo Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.category_description'), 'rows' => '1']); ?>

</div>

<div class="form-group">
  <?php echo Form::label('attrsList[]', trans('app.attributes'), ['class' => 'with-help']); ?>

  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('help.category_attributes'), false); ?>"></i>
  <?php echo Form::select('attrsList[]', $attrsList, null, ['class' => 'form-control select2-normal', 'multiple' => 'multiple']); ?>
...
<div class="row">
  <div class="col-md-6 nopadding-right">
    <div class="form-group" style="margin-bottom: 0px!important;">
      ...
      <?php if(isset($category) && Storage::exists(optional($category->coverImage)->path)): ?>
        <img src="<?php echo e(get_storage_file_url(optional($category->coverImage)->path, 'small'), false); ?>" width="" alt="<?php echo e(trans('app.cover_image'), false); ?>">
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      <?php echo Form::label('exampleInputFile', trans('app.form.featured_image'), ['class' => 'with-help']); ?>

      <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('help.featured_image', ['page' => trans('app.category')]), false); ?>"></i>
      <?php if(isset($category) && Storage::exists(optional($category->featureImage)->path)): ?>
        <img src="<?php echo e(get_storage_file_url(optional($category->featureImage)->path, 'small'), false); ?>" width="" alt="<?php echo e(trans('app.featured_image'), false); ?>">
        <span style="margin-left: 10px;">
          <?php echo Form::checkbox('delete_image[feature]', 1, null, ['class' => 'icheck']); ?> <?php echo e(trans('app.form.delete_image'), false); ?>

        </span>
      <?php endif; ?>
      <div class="row">
        <div class="col-md-9 nopadding-right">
          <input id="uploadFile1" placeholder="<?php echo e(trans('app.placeholder.category_featured_image'), false); ?>" class="form-control" disabled="disabled" style="height: 28px;" />
          <div class="help-block with-errors"><?php echo e(trans('help.featured_img_size'), false); ?></div>
        </div>
        <div class="col-md-3 nopadding-left">
          <div class="fileUpload btn btn-primary btn-block btn-flat">
            <span><?php echo e(trans('app.form.upload'), false); ?> </span>
...
<?php /**PATH C:\wamp64\www\hype-dappr\resources\views/admin/category/_form.blade.php ENDPATH**/ ?>