...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<?php echo Form::open(['route' => 'admin.vendor.merchant.store', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']); ?>
...
</div> <!-- / .modal-dialog --><?php /**PATH C:\wamp64\www\hype-dappr\resources\views/admin/merchant/_create.blade.php ENDPATH**/ ?>