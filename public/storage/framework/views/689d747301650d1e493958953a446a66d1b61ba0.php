  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        <?php echo Form::select('type', ['amount' => get_formated_currency_symbol(), 'percent' => trans('app.percent')], null, ['class' => 'selectpicker']); ?>
...
<p class="help-block">* <?php echo e(trans('app.form.required_fields'), false); ?></p><?php /**PATH C:\xampp\htdocs\hype-dappr\resources\views/admin/coupon/_form.blade.php ENDPATH**/ ?>