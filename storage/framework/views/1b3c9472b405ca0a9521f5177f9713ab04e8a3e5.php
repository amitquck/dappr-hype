<?php $__env->startSection('content'); ?>
    ...
    <?php
        ...
        {
            $combine_reveal_product = '';
            $combine_reveal_product_string = '';
            ...
            $product_details_html= '';
            $combine_reveal_product = array_merge($product_ids_arr, $alernative_product_ids_arr);
            $combine_reveal_product_string = implode(',', $combine_reveal_product);
...
<div class="container-fluid stf_outer_body stylist_step_frontend">
   <form action="<?php echo e(url('/stylist/client/submit_selection'), false); ?>" id="stylist_proceed_checkout_page" method="post">
        ...
        <input type="hidden" name="combine_reveal_product" value="<?php echo e($combine_reveal_product_string, false); ?>">
        <div class="row">
...
<?php echo $__env->make('theme::layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dappr-hype\resources\views/stylist_form/reveal_details.blade.php ENDPATH**/ ?>