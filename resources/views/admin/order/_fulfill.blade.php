  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        {!! Form::hidden('order_id', $order->id, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.carrier'), 'required' => 'required']) !!}
        {!! Form::hidden('reveal_id', $order->reveal_id, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.carrier'), 'required' => 'required']) !!}
        {!! Form::hidden('order_number', $order->order_number, ['class' => 'form-control', 'placeholder' => trans('app.placeholder.carrier'), 'required' => 'required']) !!}
