...
@section('content')
    ...
    {{-- admin.stylist.availability.time --}}
    @php
        $edit_id = 0;
        $monday = '';
        $monday_key = '';
    ...
    <form action="{{ url('/') }}/admin/stylist/availability/time" method="post" id="merchant_availibility">
        @csrf
        <input type="hidden" name="merchant_ids" value="{{ $id }}">
        <input type="hidden" name="dayscheckbox" id="dayscheckbox" value="{{ $dayscheckbox }}">
            ...
            <div class="Appointment-costom Appointment-box-costom "style="position: relative;">
                <div class="Appointment-text">
                    <input class="form-check-input weekdayname" name="day[]"
                        @php if(isset($monday_key) && $monday_key == 1){ echo "checked";} @endphp type="checkbox"
                        check-data-day="monday" value="1">
                    <h3>MONDAY</h3>
                </div>
                <div
                    class="Appointment-box-sa @php if(isset($monday_key) && $monday_key == 1){ echo ''; }else { echo "Appointment-box-hide"; } @endphp ">
                    @php
                        if (isset($monday)) {
                            echo $monday;
                        } else {
                ...
                <div
                    class="Appointment-add-new @php if(isset($monday_key) && $monday_key == 1){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    <a class="add_new_row" title="Add"><i class="fa fa-plus"></i></a>
                </div>
                {{-- <div style="visibility:hidden; color:red; " id="chk_option_error"></div> --}}
            </div>

            <div class="Appointment-costom Appointment-box-costom "style="position: relative;">
                <div class="Appointment-text">
                    <input class="form-check-input weekdayname" name="day[]" type="checkbox" check-data-day="tuesday"
                        value="2" @php if(isset($tuesday_key) && $tuesday_key == 2){ echo "checked";} @endphp>
                    <h3>TUESDAY</h3>
                </div>
                <div
                    class="Appointment-box-sa @php if(isset($tuesday_key) && $tuesday_key == 2){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    @php
                        if (isset($tuesday)) {
                            echo $tuesday;
                        } else {
            ...
            <div class="Appointment-costom Appointment-box-costom "style="position: relative;">
                <div class="Appointment-text">
                    <input class="form-check-input weekdayname" name="day[]" type="checkbox" check-data-day="wednesday"
                        value="3" @php if(isset($wednesday_key) && $wednesday_key == 3){ echo "checked";} @endphp>
                    <h3>WEDNESDAY</h3>
                </div>
                <div
                    class="Appointment-box-sa @php if(isset($wednesday_key) && $wednesday_key == 3){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    @php
                        if (isset($wednesday)) {
                            echo $wednesday;
                        } else {
                ...
                <div
                    class="Appointment-add-new @php if(isset($wednesday_key) && $wednesday_key == 3){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    <a class="add_new_row" title="Add"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            ...
            <div class="Appointment-costom Appointment-box-costom "style="position: relative;">
                <div class="Appointment-text">
                    <input class="form-check-input weekdayname" name="day[]" type="checkbox" check-data-day="thursday"
                        value="4" @php if(isset($thursday_key) && $thursday_key == 4){ echo "checked";} @endphp>
                    <h3>THURSDAY</h3>
                </div>
                <div
                    class="Appointment-box-sa @php if(isset($thursday_key) && $thursday_key == 4){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    @php
                        if (isset($thursday)) {
                            echo $thursday;
                        } else {
                ...
                <div
                    class="Appointment-add-new @php if(isset($thursday_key) && $thursday_key == 4){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    <a class="add_new_row" title="Add"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            ...
            <div class="Appointment-costom Appointment-box-costom "style="position: relative;">
                <div class="Appointment-text">
                    <input class="form-check-input weekdayname" name="day[]" type="checkbox" check-data-day="friday"
                        value="5" @php if(isset($friday_key) && $friday_key == 5){ echo "checked";} @endphp>
                    <h3>FRIDAY</h3>
                </div>
                <div
                    class="Appointment-box-sa @php if(isset($friday_key) && $friday_key == 5){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    @php
                        if (isset($friday)) {
                            echo $friday;
                        } else {
                ...
                <div
                    class="Appointment-add-new @php if(isset($friday_key) && $friday_key == 5){ echo ''; }else { echo "Appointment-box-hide"; } @endphp">
                    <a class="add_new_row" title="Add"><i class="fa fa-plus"></i></a>
                </div>
            </div>
...
@endsection
@section('page-style')
    <link rel="stylesheet" href="{{ asset('css/backend-stylist-form.css') }}">
@endsection
@section('page-script')
