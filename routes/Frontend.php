...
Route::middleware('storefront')
    ->namespace('Storefront')->group(function () {
        ...
        include 'Stylist_Frotend_Not_Login.php';
        ...
        Route::middleware(['auth:customer'])
            ->group(function () {
                ...
                // dappr stylist customize
                include 'Stylist_Frotend.php';
            });
        ...
        Route::get('dappr/join/process', [Storefront\HomeController::class, 'joinprocess']);
