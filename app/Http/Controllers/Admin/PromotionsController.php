...
class PromotionsController extends Controller
{
    ...
    /**
     * Display a listing of the All used Coupon Details.
     *
     * @return \Illuminate\Http\Response
     */
    public function couponUsed()
    {
        $order_all = Order::where("coupon_id", '!=', null)->where("customer_id", '!=', null)->with(['orderCoupon'])->with(['couponCustomer'])->get();
        return view('admin.promotions.coupon_used',compact('order_all'));
    }
}
