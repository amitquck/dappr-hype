...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request, $slug)
    {
        ...
        $booking_sessionId = Session::get('booking_id', '');
        $reveal_sessionId = Session::get('reveal_id', '');
        $customer_sessionid = Session::get('customerid', '');
        // dd($customer_sessionid);
        ...
        $cart_item_pivot_data[$item->id] = [
            ...
            'item_description' => $item->brand . ' , ' . $item->title . ' , ' . $attributes . ' , ' . $item->condition,
            'quantity' => $qtt,
            'unit_price' => $unit_price,
            'id_of_customer' => $customer_sessionid,
            'reveal_id' => $reveal_sessionId,
            'booking_id' => $booking_sessionId,
        ];
