...
class Cancellation extends BaseModel
{
    ...
    {
        if(isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='complete')
        {
            $approved_items ='';
            $declined_items = '';
            ...
            if((isset($_REQUEST['pre_approve_item']) &&  $_REQUEST['pre_approve_item'] !='') && isset($_REQUEST['request_type']) && $_REQUEST['request_type'] =='decline')
            {
                
                $approved_items = $_REQUEST['pre_approve_item'].','.$_REQUEST['approve_item'];
                $declined_items = $_REQUEST['pre_decline_item'].','.$_REQUEST['decline_item'];
            }
            else
            {
                $approved_items = $_REQUEST['approve_item'];
                $declined_items = $_REQUEST['decline_item'];
            }

            $this->forceFill(['status' => static::STATUS_COMPLETE, 'approve_items' =>$approved_items, 'decline_item' =>$declined_items])->save();
